...
public class Java125_RegEx {
	...
	public static void main(String[] args) {
		...
		//a-zA-Z_*$가 sn변수에 포함이 되어 있으면 true 아니면 false을 리턴한다.
		System.out.println(sn.matches(".*[a-zA-Z_*$].*"));

		//sn변수에 숫자 0-9가 포함되어있으면 true 아니면 false을 리턴한다.
		System.out.println(sn.matches(".*[0-9].*"));
		System.out.println(sn.matches(".*[\\d].*"));
	
	//sn변수에 숫자 0-9가 포함되어 있지않으면 true 아니면 false 리턴
	System.out.println(sn.matches(".*[^0-9].*"));
	System.out.println(sn.matches(".*[\\D].*"));
	
	//sn변수에 저장된 값이 2로 시작되면 true 아니면 false를 리턴
	System.out.println(sb.matches("2.*"));
	
	//sb변수에 저장된 값이 2로 시작하고 5로끝나면 true 아니면 false을 리턴한다.
	System.out.println(sb.matches("2.*5"));
	
	//sb변수에  저장된 값이 a이거나 b로 시작하고 임의문자가 5개이면 true 아니면 false
	System.out.println(sn.matches("[ab].{5}"));
	//st변수에 저장된 값이 a이거나 b로 시작하고 임의문자가 1~5개이며 cc로 끝나면 true 아니면 false
	st="aetwefcc";
	...
	// \\d: 숫자 , \\w:숫자 ,영문 
	    ...
	    */
		String str="The BEst things is best life are best free";
	...
	///////////////////////////////////////////////////////////////
	str="The BEst10 things in best20 lifes are best30 free";
	 pt=Pattern.compile("best",Pattern.CASE_INSENSITIVE);
	Matcher mk=pt.matcher(str);
	int j=1;
	while(mh.find())
		System.out.printf("%d번째 %d~%d %s\n",j++,mk.start(),mk.end(),mk.group());
