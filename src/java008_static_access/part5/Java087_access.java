package java008_static_access.part5;
 ...
 * 3.하나의 대상에 여러 개의 제어자를 조합해서 사용할 수 있으나, 접근제어자 단 하나만 사용할 수있다
 * 접근제어자 - public ,protected,default(=package),private
 * 그외 제어자 - static , final , abstract ,synchronized...
 * 
 * 접근제어자(Access Modifier)
 * :멤버 또는 클래스에 사용되어 ,외부로 부터의 접근을 제한한다.
 * 
 * 1. private: 정의된 클래스에서만 접근가능
 * 2. default: 같은 패키지에서만 접근가능
 * 3. protected 같은 패키지네에서 다른 패키지의 자손 클래스에 접근가능
 * 4.public 다됨
 * 
 * 
 * 접근제어자 사용
...
private int var_private =1;
        ...
        public int var_public=4;              //접근제어자  Access Modifier
